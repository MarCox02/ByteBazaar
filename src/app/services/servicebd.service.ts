...
export class ServicebdService {
  ...
  tablaTarjetas: string = "CREATE TABLE IF NOT EXISTS Tarjetas(id_tarjeta INTEGER PRIMARY KEY, rut_usuario VARCHAR(20), numero_tarjeta NUMBER, CVC NUMBER, fecha_exp NUMBER, FOREIGN KEY(rut_usuario) REFERENCES usuario(rut));";
